            ...
            l.getJSON(f + "&output=json_xml", function (b) {
                if (200 == b.responseStatus) {
                    ...
                    if (b = f.feed) {
                        ...
                        m += '<div class="rssBody" name="rssBody"><ul name="ul">';
                        for (f = e.offset; f < b.entries.length; f++) {
                            d = f - e.offset;
                            //Added by Anton Gnyady
                            //------------------------------------------------------------
                            var tmpDate = new Date(b.entries[d].publishedDate);
                            tmpDate = tmpDate.toLocaleDateString() + " " + tmpDate.toLocaleTimeString();
                            if (h.checkTitle && h.checkDate &&
                                ( (h.checkTitle.localeCompare(b.entries[d].title.replace(/&quot;/g, '\"')) !== 0 && h.checkTitle.localeCompare(b.entries[d].title.replace(/&apos;/g, '\'')) !== 0) ||
                                h.checkDate.localeCompare(tmpDate) !== 0)) {
                                continue;
                            }
                            j[d] = [];
                            var g = b.entries[f], a, c = "", k = g.link;
                            {
                                if(g.author !== "" && !authors[g.author]){
                                    authors[g.author] = 1;
                                    authors.length += 1;
                                }
                            ...
                            j[d].html = "<" + e.titletag + ' name="title"><a name="ref" href="' + e.linkredirect + k + '" title="View this feed at ' + b.title + '">' + g.title + "</a></" + e.titletag + ">";
                            e.date && a && (j[d].html += "<div name='date'>" + a + "</div>");
                            e.content && (g = e.snippet && "" != g.contentSnippet ? g.contentSnippet : g.content, e.linkcontent && (g = '<a href="' + e.linkredirect + k + '" title="View this feed at ' + b.title + '">' + g + "</a>"), j[d].html += "<p name='content'>" + g + "</p>");
                        ...
                        //Fixed by Anton Gnyady
                        for (var a in j) {
                            m += '<li class="rssRow ' + v + '" name="' + parseInt(a) + '">' + j[a].html + "</li>";
                            v = "odd" == v ? "even" : "odd";
                        }
                        //-----------------------------
                        m += "</ul></div>";
                    ...
                    l.isFunction(w) && w.call(this, u, authors.length)
